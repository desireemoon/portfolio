        ...
        <div className="about-container">
            ...
            <div className="about-info">
                ...
                <div className="bio">
                    ...
                    <p>     While I figured out my next steps, I was encouraged by friends who were programmers to learn how to code. As I started to learn the syntax and logic behind programming, I came to realize that programming filled me with the passion my prior jobs lacked. Thats when I decided to make the career switch, enroll in the software engineering program at General Assembly, and I haven't looked back since. I am looking for opportunities where I can grow both technically and professionally, while contributing towards a positive and impactful experience.</p>
                </div>
            </div>
        </div>
    )
